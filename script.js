...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var i18n = {
    en: {
      ...
      'services.reflexology.desc': '45–60 minutes of balance and calm: relieve back/neck pain, improve sleep quality, and lower stress.',
      'services.reflexology.level': 'Gentle',
      'services.reflexology.duration': '45–60 min',
    ...
    he: {
      ...
      'services.reflexology.desc': '45–60 דק’ של איזון והרגעה: הקלה בכאבי גב/צוואר, שיפור איכות השינה והפחתת סטרס.',
      'services.reflexology.level': 'קל',
      'services.reflexology.duration': '45–60 דק’',
    ...
    ar: {
      ...
      'services.reflexology.desc': '45–60 دقيقة من التوازن والتهدئة: تخفيف آلام الظهر/الرقبة، تحسين جودة النوم وتقليل التوتر.',
      'services.reflexology.level': 'لطيف',
      'services.reflexology.duration': '45–60 دقيقة',
